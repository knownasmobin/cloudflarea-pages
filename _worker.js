...
const generateRemark = (index, port) => {
    ...
    switch (index) {
        case 0:
        case 1:
            remark = `HVPN Domain_${index + 1} : ${port}`;
            break;
        case 2:
        case 3:
            remark = `HVPN IPv4_${index - 1} : ${port}`;
            break;
        case 4:
        case 5:
            remark = `HVPN IPv6_${index - 3} : ${port}`;
            break;
        default:
            remark = `HVPN Clean IP_${index - 5} : ${port}`;
            break;
    }
...
const buildWorkerLessConfig = async (env, client) => {
    ...
    fragConfig.remarks  = 'HVPN Frag - WorkerLess ⭐'
...
const getFragmentConfigs = async (env, hostName, client) => {
    ...
    bestPing.remarks = 'HVPN Frag - Best Ping 💥';
    ...
    bestFragment.remarks = 'HVPN Frag - Best Fragment 😎';
...
const getWarpConfigs = async (env, client) => {
    ...
    xrayWarpBestPing.remarks = 'HVPN Warp Best Ping 🚀'
    ...
    xrayWoWOutbounds.forEach((outbound, index) => {
        if (outbound.tag.includes('warp-out')) {
            ...
            xrayWoWConfig.remarks = `HVPN WoW ${index/2 + 1} 🌍`;
